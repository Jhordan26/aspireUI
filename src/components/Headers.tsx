...
interface Props {
  cartItems: Course[];
  toggleDrawer: (open: boolean) => void; // Función para controlar el estado del drawer
}
...
const Header: React.FC<Props> = ({ cartItems, toggleDrawer }) => {
  const cartItemCount = cartItems.length;

  // Función para abrir el drawer del carrito
